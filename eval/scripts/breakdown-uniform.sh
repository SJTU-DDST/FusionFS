...
$FXMARK_BIN_PATH/run-fxmark.py --media='pm-array' --fs='odinfs' \
    ...
    --directory_name="breakdown" --log_name="odinfs-breakdown-uniform-flush-all-data.log" --duration=10
...
$FXMARK_BIN_PATH/run-fxmark.py --media='pm-array' --fs='odinfs' \
    ...
    --ncore='1' --iotype='bufferedio' --dthread='12' --dsocket='1' \
    --rcore='False' --delegate='False' --confirm='True' \
    --directory_name="breakdown" --log_name="odinfs-breakdown-uniform-remove-all-flush.log" --duration=10
...
$FXMARK_BIN_PATH/run-fxmark.py --media='pm-array' --fs='odinfs' \
    ...
    --ncore='1' --iotype='bufferedio' --dthread='12' --dsocket='1' \
    --rcore='False' --delegate='False' --confirm='True' \
    --directory_name="breakdown" --log_name="odinfs-breakdown-uniform-flush-cold-data.log" --duration=10
...
$FXMARK_BIN_PATH/run-fxmark.py --media='pm-array' --fs='odinfs' \
    ...
    --ncore='1' --iotype='bufferedio' --dthread='12' --dsocket='1' \
    --rcore='False' --delegate='True' --confirm='True' \
    --directory_name="breakdown" --log_name="odinfs-breakdown-uniform-associativity-friendly-data-layout.log" --duration=10
