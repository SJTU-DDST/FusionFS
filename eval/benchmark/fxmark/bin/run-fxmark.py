...
class Runner(object):
    ...
    def __init__(self,
        ...
        self.BENCH_TYPES = [
            ...
            "fio_global_seq-write-4K-hot",
            "fio_global_seq-write-4K-zipf",
            "fio_global_seq-write-4K-mmap",
            "fio_global_seq-write-4K-mmap-zipf",
            ...
            "fio_global_rand-write-file-size-8M",
            "fio_global_rand-write-file-size-12M",
            "fio_global_rand-write-file-size-16M",
            "fio_global_rand-write-file-size-20M",
            "fio_global_rand-write-file-size-24M",
            "fio_global_rand-write-file-size-28M",
            "fio_global_rand-write-file-size-32M",
            "fio_global_rand-write-file-size-36M",
            "fio_global_rand-write-file-size-40M",
            "fio_global_rand-write-file-size-44M",
            ...
            # threshold
            "fio_global_threshold-hot-1K",
            "fio_global_threshold-hot-2K",
            "fio_global_threshold-hot-4K",
            "fio_global_threshold-hot-8K",
            "fio_global_threshold-hot-16K",
            "fio_global_threshold-hot-32K",
            "fio_global_threshold-hot-64K",
            "fio_global_threshold-hot-2M",
            "fio_global_threshold-cold-1K",
            "fio_global_threshold-cold-2K",
            "fio_global_threshold-cold-4K",
            "fio_global_threshold-cold-8K",
            "fio_global_threshold-cold-16K",
            "fio_global_threshold-cold-32K",
            "fio_global_threshold-cold-64K",
            "fio_global_threshold-cold-2M",
    ...
    def get_ncores(self, hint):
        ...
        for socket in range(1, cpupol.PHYSICAL_CHIPS + 1):
            if socket == 1:
                cpu_remain = cpupol.CORE_PER_CHIP - delegation_threads # IMPORTANT: 这些cpu专门用于delegate
                n = 0
